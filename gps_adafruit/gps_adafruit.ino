...
void loop() {
  ...
  while (Serial.available() > 0) {
    ...
    if (c == 'w') {
      ...
      gps_006.pause(pause_bool);
    }
  }
  
  // Pick the GPS reading and print them
  String objg = gps_006.read();
  Serial.print("GPS : "); Serial.print(objg); Serial.println("*C");
